...
func Setup(app *fiber.App) {
	...
	sup.Get("/activity-modules/sunat-inbox/export", middleware.RequirePermission(rbac.SupervisorsControlsView), supervisorCtrl.SunatInboxExportAPI)
	sup.Get("/activity-modules/sunat-inbox/month", middleware.RequirePermission(rbac.SupervisorsControlsView), supervisorCtrl.SunatInboxMonthListAPI)
	...
	sup.Get("/activity-modules/pdt-601/export", middleware.RequirePermission(rbac.SupervisorsControlsView), supervisorCtrl.Pdt601ExportAPI)

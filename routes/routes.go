...
func Setup(app *fiber.App) {
	...
	sup.Post("/activity-modules/sunat-inbox/declarations/:declarationId/validate", middleware.RequirePermission(rbac.SupervisorsDeclarationsApprove), supervisorCtrl.SunatInboxValidateAPI)
